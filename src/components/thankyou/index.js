            ...
            <div className={'container'}>
                <div className="text-holder" style={{paddingTop: '25px'}}>
                    <h3>
                        ...
                        If you have any questions or thoughts please hit us up through our live chat and one of our experts will be happy to chat with you. +972 2-500-6076<br/><br/>
